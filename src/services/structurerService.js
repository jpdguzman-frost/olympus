...
function renderCardInput(card, capsScaffold = null, { minimal = false } = {}) {
  ...
  parts.push(
    ...
    '- missingPiece: when (and only when) you flag a line "insufficient detail — draft", name the ONE',
    '  missing piece as a SHORT noun phrase, under six words, no question mark ("a when", "where this',
    '  ran", "who saw it"). Empty string on every other line.',
